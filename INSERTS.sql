...
VALUES
    ...
    (2, 1, 1, '11'), -- Atributo 'Size' de User1 aplicado a 'Smartphone'
    (2, 2, 1,'2.5'), -- Atributo 'Size' de User1 aplicado a 'Washing Machine'
    (3, 3, 2, '35'), -- Atributo 'Weight' de User2 aplicado a 'Sofa'
    (4, 4, 3, 'cotton'); -- Atributo 'Material' de User3 aplicado a 'T-Shirt'
